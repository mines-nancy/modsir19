...
class testRemoveDelta(unittest.TestCase):
    ...
    def test_remove_delta3(self):
        ...
        self.assertEqual(compute_remove_delta([1, 1, 1], 1), [0, 0, 1])
        self.assertEqual(compute_remove_delta([1, 1, 1], 2), [0, 1, 1])
        self.assertEqual(compute_remove_delta([1, 1, 1], 3), [1, 1, 1])

    def test_remove_delta5(self):
        self.assertEqual(compute_remove_delta([5, 5, 5], 5), [1, 2, 2])
        self.assertEqual(compute_remove_delta([5, 5, 5], 10), [3, 3, 4])
        self.assertEqual(compute_remove_delta([5, 0, 5], 5), [2, 0, 3])
        self.assertEqual(compute_remove_delta([5, 1, 5], 9), [4, 0, 5])
